...
public class Player extends Entity {
    ...
    public void update() {
        if (keyB.upPressed || keyB.downPressed || keyB.leftPressed || keyB.rightPressed) {
            ...
            if (keyB.upPressed)    direction = "up";
            if (keyB.downPressed)  direction = "down";
            if (keyB.leftPressed)  direction = "left";
            if (keyB.rightPressed) direction = "right";

            collisionOn = false;
            gp.collisionChecker.checkTile(this);
            gp.collisionChecker.checkNPC(this);
